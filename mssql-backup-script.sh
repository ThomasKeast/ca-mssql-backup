...
sqlcmd -S localhost -Q "BACKUP DATABASE SOS_Datatables TO DISK = N'$BACKUP_DIR/SOS_Datatables-$TIMESTAMP.bak' WITH NOFORMAT, NOINIT, SKIP, NOREWIND, STATS=10" -U $SA_USER -P $SA_PASS
